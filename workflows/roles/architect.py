...
- When `review_cycle_count >= review_cycle_limit`, do not force optional refactor/reuse/module-structure improvements into another developer revision. If correctness, interface contracts, regressions, and serious module-responsibility risks are acceptable, route to `qa_validation` and keep optional improvements as advisory insights or follow-up context.

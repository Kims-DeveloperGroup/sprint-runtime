...
- initial implementation plan draft/revision은 `proposals.initial_implementation_plan = {title, summary, requirements, approach, risks, artifacts, confirmation_prompt}` 형식으로 남기고, orchestrator가 이를 사용자 확인 요청으로 보낸다
